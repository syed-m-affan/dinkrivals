...
| --- | ---: | --- | --- | --- | --- | --- | --- | --- |
| `projection_environment_v1.png` | 979x1606 | Current projection-locked full-scene court/environment base generated from `tool/generate_projection_environment.py` | Far/base/court fill | Park green, navy fence, blue court | Medium | Court surface is aligned to `CourtProjection`; procedural gameplay lines draw above it | Current runtime environment inspired by `docs/art/concepts/concept-screenshot.png` and `concept-sheet.png` | Current |
| `park_background_overhaul.png` | 979x1606 | Historical generated full-scene park court base used before the graybox reset | Far/base | Park green and court blue | Bright-mid | Keep court corridor readable; props may layer over it | Superseded by the projection-locked runtime asset | Historical |
