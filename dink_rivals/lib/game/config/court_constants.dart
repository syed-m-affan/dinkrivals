class Court {
  ...
  static const double playerKitchenTopY = 240.0;
  static const double playerKitchenBottomY = 274.0;
  static const double opponentKitchenTopY = 206.0;
  static const double opponentKitchenBottomY = 240.0;
