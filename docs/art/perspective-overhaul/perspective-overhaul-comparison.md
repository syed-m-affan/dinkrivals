...
| Slot | File | Source |
| --- | --- | --- |
| Before | `docs/art/perspective-overhaul/perspective-before-screenshot.png` | Pre-overhaul, Pixel 10 Pro XL. Court drawn synthetically over the bg with a near-rectangular projection. |
| After  | `docs/art/perspective-overhaul/perspective-after-screenshot.png`  | Post-overhaul, Pixel 10 Pro XL (`58011FDCQ00992`), Quick Match rally state. Court is the painted pickleball floor in the bg image; gameplay coords land on it. |
| Target | `docs/art/concepts/concept-screenshot.png`            | Concept art used as the 2.5D direction. |
...
- Latest net-occlusion smoke after the painted-strip adjustment was installed and launched on emulator-5554; see docs/art/perspective-overhaul/perspective-gameplay-net-smoke-emulator.png.
