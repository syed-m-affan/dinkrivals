...
| --- | --- | --- |
| P5A-001 | done | `docs/art/phase-5-current-serve.png`, `docs/art/visual-gap-inventory.md` |
| P5A-002 | done | `docs/art/visual-direction.md` |
| P5A-003 | done | `docs/art/render-layer-map.md`, asset folders, pubspec asset declarations |
...
| P5D-003 | done | Refreshed portraits, `docs/art/phase-5d-character-check.png` |
...
| P5G-001 | done | UI golden harness, generated UI goldens, `docs/art/phase-5g-comparison.md` |
