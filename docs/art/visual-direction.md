...
- `docs/art/concept-screenshot.png`: primary target for in-match composition, HUD density, court readability, and park atmosphere.
- `docs/art/concept-sheet.png`: character, logo, UI, and asset-language reference.
- `docs/art/phase-5-current-serve.png`: current implementation baseline for gap comparisons.
- `docs/art/visual-gap-inventory.md`: current list of known gaps.
