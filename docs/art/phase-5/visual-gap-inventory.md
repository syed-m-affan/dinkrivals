...
- Current Phase 5 baseline: `docs/art/phase-5/phase-5-current-serve.png`
- Concept target: `docs/art/concepts/concept-screenshot.png`
- Concept sheet: `docs/art/concepts/concept-sheet.png`
- Earlier perspective reference: `docs/art/phase-0/p0-006-p0-007-perspective-screenshot.png`
