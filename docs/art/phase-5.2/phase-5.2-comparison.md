...
- Baseline/delta inventory: `docs/art/phase-5.2/phase-5.2-delta-inventory.md`
- Visual rules and prompt direction: `docs/art/phase-5.2/phase-5.2-art-direction.md`
- Generated asset contact sheet: `docs/art/phase-5.2/phase-5.2-generated-asset-contact-sheet.png`
- Emulator menu smoke: `docs/art/phase-5.2/phase-5.2-emulator-smoke.png`
- Emulator gameplay smoke: `docs/art/phase-5.2/phase-5.2-gameplay-emulator-smoke.png`
- Final menu screenshot: `docs/art/phase-5.2/phase-5.2-final-menu.png`
- Final serve screenshot: `docs/art/phase-5.2/phase-5.2-final-serve.png`
- Final rally screenshot: `docs/art/phase-5.2/phase-5.2-final-rally.png`
- Final feedback screenshot: `docs/art/phase-5.2/phase-5.2-final-feedback.png`
- Final pause screenshot: `docs/art/phase-5.2/phase-5.2-final-pause.png`
- Final end-match screenshot: `docs/art/phase-5.2/phase-5.2-final-endmatch.png`
- Updated UI golden: `docs/art/phase-5/phase-5g-endmatch.png`
...
| Character animation framing | Resolved | Generated shot sheets now render using their actual frame counts instead of hardcoded multi-frame slicing, so one-frame shot poses no longer show only half the character. Player and opponent sprites also reflect horizontally based on movement direction, and player point-result poses remain visible after a point ends. |
...
| Feedback banner | Resolved | Rally feedback renders in a top-center banner with primary/secondary text helpers and safe-area-aware placement. Point/fault feedback now survives point reset, and misses use miss-specific copy. |
