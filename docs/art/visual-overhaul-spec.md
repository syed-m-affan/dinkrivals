...
This spec defines an agent-friendly plan to raise the visual quality of Dink Rivals until the in-game experience feels close to the approved concept screenshot in `docs/art/concept-screenshot.png`, while keeping the game readable and playable on Android.
...
- `docs/art/phase-5.2-gameplay-emulator-smoke.png`
- `docs/art/phase-5.2-emulator-smoke.png`
- `docs/art/phase5_current.png`
...
- `docs/art/phase-5.2-delta-inventory.md`
...
- Net render order follows `docs/art/render-layer-map.md`.
