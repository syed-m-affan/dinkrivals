...
- `docs/art/concept-screenshot.png` — the back fence and foliage band sits just above the far baseline, far baseline meets the court apron without a visible step, and props (benches, lamps) anchor to court coordinates that respect the new perspective.
