...
After P0-007 the raised net renders as 7 evenly-spaced vertical struts between a top cord and a ground cord, with thick post lines at each end. The result looks like piano keys / a barcode rather than a pickleball net. Reference: `docs/art/p0-006-p0-007-perspective-screenshot.png` — the net is the most confusing element in the scene.
