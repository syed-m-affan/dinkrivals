...
- `docs/art/phase-5.1-comparison.md`
- `docs/art/phase-5.1-*.png`
...
- `docs/art/phase-5.1-comparison.md` shows concept / before / after evidence.
...
- 2026-05-11: Captured `docs/art/phase-5.1-final-serve.png`, `docs/art/phase-5.1-final-rally.png`, and `docs/art/phase-5.1-final-pause.png`.
