...
Lock the Phase 5.2 starting point and create an implementation-grade delta inventory against `docs/art/concept-screenshot.png` and `docs/art/concept-sheet.png`.
...
- `docs/art/phase-5.2-baseline-*.png`
- `docs/art/phase-5.1-final-*.png` (reference only unless capturing a missing baseline)
...
- `docs/art/phase-5.2-delta-inventory.md` exists and is specific enough for implementation agents to work from.
