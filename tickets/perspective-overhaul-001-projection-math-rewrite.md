...
- Problem: `docs/art/perspective-before-screenshot.png` — weak trapezoid, equal entity sizes, flat z lift.
- Target: `docs/art/concept-screenshot.png` — strong trapezoid, near baseline visibly wider than far, near entities clearly larger, ball lift reads clearly.
