...
- `docs/art/phase-5/render-layer-map.md` (new)
...
- Create `docs/art/phase-5/render-layer-map.md` documenting intended order for:
...
- Added `docs/art/phase-5/render-layer-map.md` with draw order, occlusion rules, SafeArea rules, folder conventions, and naming conventions.
