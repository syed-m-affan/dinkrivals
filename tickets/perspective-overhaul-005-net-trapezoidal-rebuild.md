...
- `docs/art/concept-screenshot.png` — net cord is a clean line that *looks* parallel to the baseline but is shorter on the far side; mesh strokes converge with the side lines; posts cast a shadow on the court that respects the new perspective.
