...
`DebugOverlayComponent` renders a single-line strip at `Rect.fromLTWH(8, 8, 342, 22)`. On a typical phone (~412 logical px wide), this extends to x=350, which overlaps the centered score chip at the top of the screen. Reference: `docs/art/phase-0/p0-006-p0-007-perspective-screenshot.png` — the "0 - 0" score sits behind "PHASE 0  FPS 118  ...".
