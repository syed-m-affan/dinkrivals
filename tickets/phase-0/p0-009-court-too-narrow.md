...
After P0-006 the court fills vertically but is now far too narrow — it occupies ~55-65% of the screen width on a Pixel 10 Pro XL portrait viewport. Reference: `docs/art/phase-0/p0-006-p0-007-perspective-screenshot.png`. Concept fills ~95%.
