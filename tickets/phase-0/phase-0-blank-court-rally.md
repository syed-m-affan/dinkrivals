...
Read `docs/specs/build-spec.md` before starting. The non-negotiable rules in Section 2 of the spec apply to all code you write. Pay particular attention to:
