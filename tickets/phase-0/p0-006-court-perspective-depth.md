...
Retune the gray-box court projection so the gameplay camera feels closer to `docs/art/concepts/concept-screenshot.png` and less like the flatter `docs/art/phase-2/phase-2-screenshot.png`.
...
- Desired direction: `docs/art/concepts/concept-screenshot.png`.
- Current problem reference: `docs/art/phase-2/phase-2-screenshot.png`.
...
- Compare the new view against `docs/art/concepts/concept-screenshot.png` and `docs/art/phase-2/phase-2-screenshot.png`.
