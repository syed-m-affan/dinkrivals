...
This is the checkpoint for the user-reported issue: Phase 2 perspective feels too top-down and lacks depth compared with `docs/art/concepts/concept-screenshot.png`.
...
- `tickets/phase-0/p0-008-perspective-device-qa.md`.
- `tickets/status.md`.
...
- Compare against:
  ...
  - `docs/art/phase-2/phase-2-screenshot.png`.
