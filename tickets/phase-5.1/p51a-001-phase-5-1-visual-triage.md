...
Lock the current Phase 5.1 visual baseline and create a precise concept-delta inventory against `docs/art/concepts/concept-screenshot.png`.
...
- `docs/art/phase-5.1/phase-5.1-delta-inventory.md`
- `docs/art/phase-5/render-layer-map.md`
- `docs/art/phase-5/visual-direction.md`
- `docs/art/phase-5/phase-5-screenshot.png` or `docs/art/phase-5.1/phase-5.1-screenshot.png`
- `tickets/status.md`
...
- Compare the baseline against `docs/art/concepts/concept-screenshot.png`.
...
- `docs/art/phase-5.1/phase-5.1-delta-inventory.md` exists and is specific enough for implementation agents to work from.
