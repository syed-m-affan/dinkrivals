...
- `docs/specs/build-spec.md` non-negotiables, especially "gameplay feel before menus/monetization".
...
Manual: 5-minute rally on an Android device. Note frame-rate and crashes per `docs/specs/build-spec.md` §5.4.
