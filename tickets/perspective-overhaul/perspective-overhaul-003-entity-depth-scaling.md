...
- `docs/art/concepts/concept-screenshot.png` — opponent height is roughly 0.6× the player's projected height; both stand on the court surface and their feet anchor to the projected ground.
